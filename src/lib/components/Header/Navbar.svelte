<script>
	...
	const responsive = 'md:w-[700px] md:mx-auto lg:w-[700px] lg:mx-auto rounded-lg';

	let isBurgerOpen = true;
	let open = false;
</script>

<nav class="{responsive} dark:bg-gray-900 bg-gray-50 mx-3 mt-2 rounded border border-blue-300">
